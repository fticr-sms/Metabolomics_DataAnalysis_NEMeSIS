...
other type of data if it follows the formatting rules as declared in the "Data Reading" page.<br>
- Thus, it can handle not only Direct Infusion FT-ICR-MS data but also LC-MS and GC-MS data. It will not use the time
retention parameters of the latter 2 and as such may not be the most suitable tool to analyse said data.<br>
<br>
...
compound analysis and data diversity visualization tools (Van Krevelen and Chemical Composition Series).<br>
- It also includes statistical analysis performe on data treated with Binary Simplification (BinSim),
that is, feature occurrence data that can be useful for extreme-resolution data with plenty of missing values. <br>
...
- Every Figure generated by the software can be downlaoded and a final report of the analysis can also be generated.

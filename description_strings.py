...
those exact values; if it is the latter, a Neutral Mass column will be generated by adding a proton or subtracting an H-
ion to the values of the column. Albeit not necessary, it will allow to perform annotation later on in the software.
<strong>Avoid the existence of a column named "Neutral Mass" on your data.</strong>
<br>
<br>
